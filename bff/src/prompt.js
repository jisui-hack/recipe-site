...
### それぞれの中身
- **紹介文は1〜2文。** その食材をどう扱うのが基本かを言い切り、この料理を名指しする。
  例:「豚ひき肉は炒め料理を基本に考える。おすすめはドライカレー。」
...
- **作り方は1行に1手順。** 行頭に半角数字と半角スペース。**多くても5行。**
  **各行は12文字前後まで。** 体言止めでも言い切りでもよいが、1行に2つの動作を入れない。
    ...
    input_schema: {
      ...
      properties: {
        ...
        xPost: {
          ...
          maxLength: 145,
          description:
            "X に投稿する文。改行を含めて145文字以内。説明文ではなくレシピそのもの。" +
            "1〜2文の紹介 → 空行 → 【材料】◯人分 と1行1材料 → 空行 → 【作り方】と1行1手順。" +
